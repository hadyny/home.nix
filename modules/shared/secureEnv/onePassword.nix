  ...
  populateSecrets =
    ...
    let
      ...
      syncOneVariable = key: item: ''
        ...
        # Cache for shell startup
        echo "export ${key}=\"$password\"" >> ~/.zshenv.local
        echo "\$env.${key} = \"$password\"" >> ~/.config/nushell/secrets.nu
      '';
    ...
    pkgs.writeShellScript "populateKeys" ''
      ...
      # Reset cache files
      echo "# Generated by nix-darwin" > ~/.zshenv.local
      mkdir -p ~/.config/nushell
      echo "# Generated by nix-darwin" > ~/.config/nushell/secrets.nu
